...
export default function Login() {
  ...
  const handleGoogleReturn = async () => {
    ...
    // No profile at all (RLS blocked or brand-new identity) → try linking.
    if (!profile) {
    ...
    // handle_new_user with role='teacher' when the real account is password-based).
    // Try linking the Google identity into the existing provisioned account first.
