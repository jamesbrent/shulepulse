...
export default function TeacherAppHome({
  ...
  return (
    <div className="mx-auto min-h-screen max-w-md bg-slate-50 font-sans">
      ...
      <div className="mx-4 mt-4 rounded-2xl border border-slate-100 bg-white p-4">
        <p className="mb-3 text-base font-bold text-slate-900">Quick actions</p>
          ...
          {actions.map((action) => {
            ...
            return (
              <button
                ...
                className="flex flex-col items-center gap-2 rounded-xl border border-slate-100 px-2 py-4 text-center hover:bg-slate-50"
              >
                <span className={`flex h-10 w-10 items-center justify-center rounded-full ${QUICK_ACTION_STYLES[action.color] || QUICK_ACTION_STYLES.blue}`}>
