  ...
  const buildDocument = (s, type) => {
    ...
    const headerBlock = `
      <div style="text-align:center;margin-bottom:20px;border-bottom:2px solid #1e3a5f;padding-bottom:12px">
        ${logoHtml}
        <div style="font-size:16pt;font-weight:700;color:#1e3a5f">${schName}</div>
        <div style="font-size:9pt;color:#666;font-style:italic">"${schMotto}"</div>
        <div style="font-size:8pt;color:#888">${schAddress} | Tel: ${schPhone}</div>
        <div style="font-size:7pt;color:#999">Ministry Reg: ${schRegId}</div>
      </div>`
    ...
    const body = {
      admission_letter: `
        ...
        <div style="font-size:9pt;margin-bottom:8px">Dear ${s.parent_name || 'Parent/Guardian'},</div>
        <div style="font-size:10pt;font-weight:600;margin-bottom:8px">RE: ADMISSION OF ${s.full_name.toUpperCase()} (ADM NO: ${s.admission_number})</div>
        <div style="font-size:9pt;line-height:1.7;text-align:justify">We are pleased to inform you that your child, <strong>${s.full_name}</strong>, has been offered admission to <strong>${schName}</strong> for the academic year ${currentYear}.</div>
      ...
      transfer_letter: `
        ...
        <div style="font-size:9pt;text-align:right;color:#666">Date: ${date}</div><div style="font-size:9pt;color:#888;margin-bottom:12px">Ref: ${docId}</div>
        <div style="font-size:10pt;font-weight:600;margin-bottom:8px">RE: TRANSFER OF ${s.full_name.toUpperCase()}</div>
        <div style="font-size:9pt;line-height:1.7;text-align:justify">This certifies that <strong>${s.full_name}</strong> (Admission No: ${s.admission_number}) was a bonafide student of ${schName} and is authorized to transfer.</div>
      ...
      leaving_certificate: `
        ...
        <div style="font-size:9pt;text-align:right;color:#666">Date: ${date}</div><div style="font-size:9pt;color:#888;margin-bottom:12px">Ref: ${docId}</div>
        <div style="font-size:10pt;font-weight:600;margin-bottom:8px">RE: LEAVING CERTIFICATE — ${s.full_name.toUpperCase()}</div>
      ...
      bonafide_letter: `
        ...
        <div style="font-size:9pt;text-align:right;color:#666">Date: ${date}</div><div style="font-size:9pt;color:#888;margin-bottom:12px">Ref: ${docId}</div>
        <div style="font-size:10pt;font-weight:600;margin-bottom:8px">RE: BONAFIDE STUDENT LETTER — ${s.full_name}</div>
      ...
      recommendation_letter: `
        ...
        <div style="font-size:9pt;text-align:right;color:#666">Date: ${date}</div><div style="font-size:9pt;color:#888;margin-bottom:12px">Ref: ${docId}</div>
        <div style="font-size:10pt;font-weight:600;margin-bottom:8px">RE: RECOMMENDATION FOR ${s.full_name.toUpperCase()}</div>
        <div style="font-size:9pt;line-height:1.7;text-align:justify">I am pleased to recommend <strong>${s.full_name}</strong> (Admission No: ${s.admission_number}) of ${schName}.</div>
      ...
      fee_clearance: `
        ...
        <div style="font-size:9pt;line-height:1.7;text-align:justify">This certifies that ${s.full_name} has cleared all financial obligations with ${schName} as of ${date}.</div>`,
    }[type]
